...
<div align="center">
  ...
  <p>
    <a href="https://www.npmjs.com/package/@direct.dev/ethers-v5"><img alt="NPM Version" src="https://img.shields.io/npm/v/%40direct.dev%2Fethers?style=for-the-badge&labelColor=555&color=00BCB1"></a>
    <a href="https://bundlephobia.com/package/@direct.dev/ethers-v5"><img alt="NPM Bundle size" src="https://img.shields.io/bundlephobia/minzip/%40direct.dev%2Fethers?style=for-the-badge&labelColor=555&color=00BCB1"></a>
...
```ts
// Import dependencies
import DirectProvider from "@direct.dev/ethers-v5";
