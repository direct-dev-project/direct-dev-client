...
/**
 * Branded subtype of string for usage with normalized RPC request methods, to
 * ensure consistent request identification
 */
type DirectRequestMethod = string & { readonly __brand: unique symbol };
 ...
 */
type DirectCacheKey = DirectRequestHash | `${DirectRequestHash}:${RPCBlockHeight | "latest"}`;

/**
 * branded subtype of string, to verify correctness of response hash usage in
 * all integrations
 *
